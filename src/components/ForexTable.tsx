  ...
  const rules = [
    {
      ...
      assessment: "10%",
      funded: "-",
      note: "Funded account has no profit limit",
    },
    {
      area: "Daily Loss Limit",
      assessment: "5%",
      funded: "5%",
      note: "Equity-based, based on prior day balance (Hard Breach)",
    },
    {
      area: "Max Drawdown",
      assessment: "6%",
      funded: "6%",
      note: "Equity-based, does not trail (Hard Breach)",
    },
    {
      area: "Inactivity Period",
      assessment: "30 Days",
      funded: "30 Days",
      note: "Must place trade (Hard Breach)",
    },
      ...
      <Carousel className="w-full">
        <CarouselContent>
          {accountSizes.map((size, index) => (
            ...
            >
              <div className="p-1">
                <Card className="overflow-hidden border-purple-500/20 shadow-md hover:border-purple-500/40 transition-all h-full flex flex-col">
                  ...
                  <div className="p-4 space-y-3 flex-1">
                    {rules.map((rule, ruleIndex) => (
                      <div
                        key={ruleIndex}
                        className="pb-2 border-b border-purple-500/10 last:border-b-0"
                      >
                        ...
                        {rule.note && (
                          <p className="text-white/70 text-xs">{rule.note}</p>
                        )}
                      </div>
                    ))}
                  </div>
